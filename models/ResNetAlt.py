...
def resnet_alt_18(n_class=100):
    ...
    """
    return ResNetAlt(BasicBlock, [2, 2, 2, 2], num_classes=n_class)

def resnet_alt_34(n_class):
    """ return a ResNet 34 object
    """
    return ResNetAlt(BasicBlock, [3, 4, 6, 3], num_classes=n_class)

def resnet_alt_50(n_class):
    """ return a ResNet 50 object
    """
    return ResNetAlt(BottleNeck, [3, 4, 6, 3], num_classes=n_class)

def resnet_alt_101(n_class):
    """ return a ResNet 101 object
    """
    return ResNetAlt(BottleNeck, [3, 4, 23, 3], num_classes=n_class)

def resnet_alt_152(n_class):
    """ return a ResNet 152 object
    """
    return ResNetAlt(BottleNeck, [3, 8, 36, 3], num_classes=n_class)
