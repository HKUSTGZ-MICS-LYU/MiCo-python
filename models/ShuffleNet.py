...
class ChannelShuffle(nn.Module):
    ...
    def __init__(self, channels, groups):
        ...
        self.MiCo_func = MiCoFunc(
            name="MiCo_channel_shuffle",
            params=[self.channels, self.groups]
        )
...
class ShuffleNetUnit(nn.Module):
    ...
    def __init__(self, input_channels, output_channels, stage, stride, groups):
        ...
        self.channel_shuffle = ChannelShuffle(int(output_channels / 4), groups)
...
def shufflenet(n_class = 100):
    return ShuffleNet([4, 8, 4], num_classes=n_class)