...
+ `MiCoTorchMLIRGen`: MLIR code generator using torch-mlir as first pass (see [doc/MLIR_INTEGRATION.md](doc/MLIR_INTEGRATION.md)).
...
# Use torch-mlir as first pass (requires: pip install torch-mlir)
