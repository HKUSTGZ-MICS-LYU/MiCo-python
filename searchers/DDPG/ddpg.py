...
from searchers.DDPG.memory import SequentialMemory

from searchers.DDPG.utils import to_numpy, to_tensor, sample_from_truncated_normal_distribution
...
class DDPG(object):
    def __init__(self, nb_states, nb_actions, seed, n_layers):
        ...
        self.memory = SequentialMemory(limit=128*n_layers, window_length=1)
